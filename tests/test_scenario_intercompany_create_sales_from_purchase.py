...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(sale.comment, purchase_comment)
        self.assertEqual(sale.party, purchase_party)
        self.assertEqual(sale.currency, purchase_currency)
        ...
        for purchase_line, sale_line in zip(purchase_lines, sale.lines):
            ...
            self.assertEqual(sale_line.unit_price in (sale_line.product.list_price_used, purchase_line['cost_price']), True)
